...
const questions = [
  ...
  {
    question: "Which is a synonym of 'Eloquent'?",
    options: ["Silent", "Fluent", "Unclear", "Dull"],
    answer: "Fluent",
  },
  {
  ...
  {
    question: "Fill in the blank: He is good ___ playing the guitar.",
    options: ["in", "at", "on", "to"],
    answer: "at",
  },
  {
    question: "Choose the antonym of 'Generous':",
    options: ["Kind", "Selfish", "Loyal", "Gentle"],
    answer: "Selfish",
  },
  ...
  ...Array(45).fill().map((_, i) => ({
    ...
    answer: "Option " + (i % 4 === 0 ? "A" : i % 4 === 1 ? "B" : i % 4 === 2 ? "C" : "D")
  }))
];
  ...
  const FloatingParticles = () => (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      {[...Array(30)].map((_, i) => (
        <div
          key={i}
          className="absolute w-1 h-1 bg-gradient-to-r from-indigo-400 to-pink-500 rounded-full animate-pulse opacity-30"
          style={{
            ...
            <div className="bg-slate-800/30 backdrop-blur-md rounded-3xl p-12 border border-slate-700/50 shadow-2xl">
              ...
              <div className="mb-8">
                ...
                <div className="text-2xl text-gray-300 mb-4">
                  Score: <span className="text-indigo-400 font-semibold">{getScorePercentage()}%</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <button 
                  ...
                  className="w-full px-8 py-4 bg-gradient-to-r from-indigo-500 to-pink-600 hover:from-pink-600 hover:to-indigo-500 text-white rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl"
                >
      ...
      <div className="relative z-10 min-h-screen p-6">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-700">
              <span className="text-pink-400 font-semibold">Time: {timeElapsed}s</span>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          <div className="text-6xl mb-4 animate-bounce">
            <FaBook className="text-indigo-400 mx-auto" />
          </div>
          ...
          <p className="text-xl text-gray-300">Test your English grammar, vocabulary, and communication skills</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-800/30 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-slate-700/50 shadow-2xl mb-8 transition-all duration-500 hover:shadow-3xl">
            <div className="flex items-start gap-4 mb-8">
              <div className="bg-gradient-to-r from-indigo-500 to-pink-600 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl shrink-0">
                {currentQuestion + 1}
              </div>
            ...
            {showFeedback && (
              <div className="text-center mt-8">
                <button
                  onClick={handleNext}
                  className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-pink-600 hover:from-pink-600 hover:to-indigo-500 text-white rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20 text-center">
              <FaStar className="text-indigo-400 text-2xl mx-auto mb-2" />
              <div className="text-lg font-semibold text-white">{score}</div>
